<script lang="ts">
  ...
  import type { BaseProps, FullWidthComponent, KeyboardHandler } from '@ui/type/component'
  ...
  let inputClasses = $derived.by(() => {
    const base =
      'w-full pl-12 pr-3.25 py-3.25 text-body-m text-neutral-900 bg-neutral-50 border rounded-xl transition-all duration-200 focus:outline-none focus:ring-offset-0 placeholder:text-neutral-500'
