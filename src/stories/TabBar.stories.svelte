...
<Story name="Two Tabs Only" args={{ tabs: [{ id: 'tab1', label: 'Tab 1', icon: InboxIcon }, { id: 'tab2', label: 'Tab 2', icon: ExploreIcon }] }}>
	{#snippet template(args)}
		<TabBar {...args} />
	{/snippet}
</Story>

<Story name="Long Labels" args={{ tabs: [
...
<Story name="All States">
	{#snippet template()}
		<div class="space-y-8">
			<div>
				<h3 class="text-neutral-800 mb-4">Basic Navigation</h3>
				<TabBar tabs={basicTabs} activeTab="tab1" />
			</div>
			
			<div>
				<h3 class="text-neutral-800 mb-4">With Many Tabs</h3>
				<TabBar tabs={manyTabs} activeTab="tab3" />
			</div>
			
			<div>
				<h3 class="text-neutral-800 mb-4">With Disabled Tabs</h3>
...
<Story name="Interactive Example">
	{#snippet template()}
		<div class="space-y-8">
			<div>
				<h3 class="text-neutral-800 mb-4">App Navigation</h3>
				<TabBar 
					tabs={[
						{ id: 'home', label: 'Home', icon: InboxIcon },
						{ id: 'explore', label: 'Explore', icon: ExploreIcon },
			...
			<div>
				<h3 class="text-neutral-800 mb-4">Settings Navigation</h3>
				<TabBar 
					tabs={[
			...
			<div>
				<h3 class="text-neutral-800 mb-4">Student Dashboard</h3>
				<TabBar 
					tabs={[
