...
const allComponents = [
  ...
  { name: 'Banner', story: 'overview', section: 'content-banner' },
  { name: 'Button', story: 'overview', section: 'core-button' },
  { name: 'Calendar', story: 'overview', section: 'controls-calendar' },
  { name: 'Card', story: 'overview', section: 'content-card' },
  { name: 'CardHorizontal', story: 'overview', section: 'content-cardhorizontal' },
  { name: 'Checkbox', story: 'overview', section: 'forms-checkbox' },
  { name: 'Container', story: 'overview', section: 'layout-container' },
  ...
  { name: 'Tag', story: 'overview', section: 'content-tag' },
