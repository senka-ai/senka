	...
	{#snippet template()}
		<div class="space-y-8 p-4">
			<div>
				...
				<div class="mt-2 text-body-s text-secondary">Photos from this week</div>
			</div>
			
			<div>
				<ListTitle title="Shopping List" rightText="Edit" />
				<div class="mt-2 text-body-s text-secondary">5 items remaining</div>
			</div>
			...
			<div>
				...
				<div class="mt-2 text-body-s text-secondary">Found 24 matches</div>
			</div>
		</div>
	{/snippet}
</Story>