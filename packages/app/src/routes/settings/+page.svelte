  ...
  <div class="settings-grid">
    <div class="card">
      <div class="section-header">
        ...
        <Button variant="tertiary" size="small" onclick={toggleEdit}>
          {#snippet children()}
      ...
      <div class="profile-form">
        <TextField label="Nume complet" bind:value={userSettings.name} disabled={!isEditing} />

        <TextField label="Email" type="email" bind:value={userSettings.email} disabled={!isEditing} />

        <TextField label="Școală" bind:value={userSettings.school} disabled={!isEditing} />

        <TextField label="Clasa" bind:value={userSettings.class} disabled={!isEditing} />

        {#if isEditing}
          <div class="form-actions">
            <Button variant="primary" size="small" onclick={saveSettings}>
