<script module>
	...
	const { Story } = defineMeta({
		...
		parameters: {
			docs: {
				description: {
					component: 'A theme toggle component that switches between light and dark themes. The component automatically detects system preference and persists the user\'s choice in localStorage.'
				}
			}
		}
	})
...
<Story name="All Sizes">
	{#snippet template()}
		<div class="space-y-4">
			<h3 class="text-lg font-semibold text-primary">Theme Toggle Sizes</h3>
...
<Story name="In Context">
	{#snippet template()}
		<div class="bg-background p-6 rounded-lg border border-default">
