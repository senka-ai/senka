...
<div class="schedule-page">
  <header class="schedule-header">
    ...
    <div class="view-toggle">
      <Button variant={viewMode === 'day' ? 'primary' : 'tertiary'} size="small" onclick={() => setViewMode('day')}>
        {#snippet children()}Ziua{/snippet}
      </Button>
      <Button variant={viewMode === 'week' ? 'primary' : 'tertiary'} size="small" onclick={() => setViewMode('week')}>
